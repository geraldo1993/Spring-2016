...
{  
	...
	int counter=2; // declare the value for counter, that will be used in next for loop function
...
} //Program is not runnig properly as far as I could observe it, I am figuring out what is wrong. 
//I assume that mistake is somewhere in prime funtion!!!
